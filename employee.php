    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="container">
                ...
                ?>
                <h1></h1>
                <a href="manager.php" class="btn btn-dark mb-3">Manager</a> &nbsp;
                <a href="trainer.php" class="btn btn-dark mb-3">Trainer</a> &nbsp;<a href="maintainer.php"
                    class="btn btn-dark mb-3">Maintainer
                </a>
