...
$sql = "SELECT * from gym_equipment where (equipment_id=$equipment_id)" ;
...
$row = mysqli_fetch_array($result);
 ...
 if (isset($_POST["submit"])) 
 {
    ...
    $sql_query="UPDATE gym_equipment SET equipment_id='$equipment_id',equipment_name='$equipment_name' WHERE equipment_id ='$equipment_id' " ;
                ...
                <form action="" method="post" style="width:50vw; min-width:300px;">
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <input type="text" name="equipment_id" value="<?php echo $row['equipment_id']  ?>"
