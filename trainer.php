    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="container">
                ...
                ?>
                <h1></h1>
                <a href="addtrainer.php" class="btn btn-dark mb-3">Add New Trainer</a>
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        <?php
        $sql_query = "SELECT e.eid,e.ename,e.eaddress,e.SSN,e.ephone_number,e.salary,e.B_no,e.Salary,t.Training_type
        FROM employee as e join trainer as t 
        WHERE (e.eid=t.eid)";
            ...
            ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="Edittrainer.php?eid=<?php echo $row["eid"] ?>"> <button type="button"
                            ...
                            <td>
                                ...
                                <a href="Deletetrainer.php?eid=<?php echo $row["eid"] ?>"> <button type="button"
