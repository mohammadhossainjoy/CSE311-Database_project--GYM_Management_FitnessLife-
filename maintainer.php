    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="container">
                ...
                ?>
                <h1></h1>
                <a href="addmaintainer.php" class="btn btn-dark mb-3">Add New Maintainer</a>
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        <?php
        $sql_query = "SELECT e.eid,e.ename,e.eaddress,e.SSN,e.ephone_number,e.B_no,e.Salary
         FROM employee as e join maintainer as m 
         ON (e.eid=m.eid) ";
            ...
            ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="Editmaintainer.php?eid=<?php echo $row["eid"] ?>"> <button type="button"
                            ...
                            <td>
                                ...
                                <a href="Deletemaintainer.php?eid=<?php echo $row["eid"] ?>"> <button type="button"
