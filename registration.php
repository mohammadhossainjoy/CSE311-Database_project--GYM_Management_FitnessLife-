...
if (isset($_POST["pack_select"])) {
  ...
  $sql_query = "INSERT INTO customer(id, fname, lname, phone_no, email, address, password, pack_id, start_date, end_date) 
    VALUES ('$id','$fname','$lname','$phone_no','$email','$address','$password','$package','$start_date','$end_date')";
