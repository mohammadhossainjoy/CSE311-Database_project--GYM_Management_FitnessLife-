...
if (isset($_POST["submit"])) {
    ...
    $sql_query = "INSERT INTO employee(eid,ename,eaddress,SSN,ephone_number,adname,B_no,Salary)
     ...
     INSERT into manager(eid,Br_no)
	 VALUES ('$eid','$Bno')";

   

    if ($conn->multi_query($sql_query) == true) {
        header("Location: manager.php?msg=New record created successfully");
    } else {
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="text-center mb-4">
                ...
                <p class="text-muted">Complete the form below to add a new Manager</p>
            </div>
            ...
            ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="branch_no" id="">
                            ...
                            <?php
                             include "connect.php";
                            $Br_no = mysqli_query($conn, "SELECT * from branch");
                            while ($c = mysqli_fetch_array($Br_no)) {
                                ?>
