    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="container">
                ...
                <h1 align="center">Gym Equipment</h1>
                <a href="addgymEquipt.php" class="btn btn-dark mb-3">Add New</a>
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        <?php
                           $sql_query = "SELECT * FROM `gym_equipment`";
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="equipedit.php?equipment_id=<?php echo $row["equipment_id"] ?>"> <button
                                        type="button" class="btn btn-danger">Edit</button></a>
                            </td>
                            <td>

                                <a href="equipdelete.php?equipment_id=<?php echo $row["equipment_id"] ?>"> <button
