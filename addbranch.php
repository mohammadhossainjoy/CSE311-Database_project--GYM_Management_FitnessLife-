...
if (isset($_POST["submit"])) {
    ...
    $sql_query = "INSERT INTO branch(Branch_no,baddress)
	 VALUES ('$Branch_no','$baddress')";
                ...
                <form action="" method="post" style="width:50vw; min-width:300px;">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" name="Branch_no" placeholder="" required>
                        </div>

                        <div class="col">
                            <label class="form-label">Branch Address:</label>
                            <input type="text" class="form-control" name="baddress" placeholder="" required>
                        </div>
                    </div>
