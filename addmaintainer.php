...
if (isset($_POST["submit"])) {
    ...
    $sql_query = "INSERT INTO employee(eid,ename,eaddress,SSN,ephone_number,adname,B_no,Salary)
     ...
     INSERT into maintainer(eid)
	 VALUES ('$eid');
     INSERT into maintains(eid,equip_id)
     VALUES('$eid','$gym')
     ";
    ...
    if ($conn->multi_query($sql_query) == true) {
        header("Location: maintainer.php?msg=New record created successfully");
    } else {
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="text-center mb-4">
                <h3>Add New maintainer</h3>
                <p class="text-muted">Complete the form below to add a new Maintainer</p>
            </div>
            ...
            <div class="container d-flex justify-content-center">
                <form action="" method="post" style="width:50vw; min-width:300px;">
                    ...
                    <div class="form-group">
                        <label class="form-label">
                            <p style="color:black ">Equipment ID:</p>
                        </label>
                        <select name="gym" id="">

                            <?php
        include "connect.php";
        $gym = mysqli_query($conn, "SELECT * from gym_equipment");
        while ($c = mysqli_fetch_array($gym)) {
            ?>

                            <option value="<?php echo $c['equipment_id'] ?>">
                                <?php echo $c['equipment_id'] ?>&nbsp;<p>-&nbsp;</p><?php echo $c['equipment_name'] ?>
                            </option>
                            <?php } ?>
                        </select>
                    </div>
