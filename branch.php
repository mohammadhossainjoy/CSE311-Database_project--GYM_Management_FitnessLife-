    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="container">
                ...
                ?>
                <a href="addbranch.php" class="btn btn-dark mb-3">Add New</a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="branchedit.php?Branch_no=<?php echo $row["Branch_no"] ?>"> <button
                                        type="button" class="btn btn-danger">Edit</button></a>
                            </td>
                            <td>

                                <a href="branchdelete.php?Branch_no=<?php echo $row["Branch_no"] ?>"> <button
